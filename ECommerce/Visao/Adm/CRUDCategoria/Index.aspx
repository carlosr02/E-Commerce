<%@ Page Title="" Language="C#" MasterPageFile="~/Visao/Adm/AdmMasterPage.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="ECommerce.Visao.Adm.CRUDCategoria.Index" Theme="css" %>
    ...
    <div id="contact-page" class="container">
        <div class="bg">
            <div class="row">
                <div class="col-sm-12">
                    <h2>Categorias</h2>
                    <asp:Button ID="Button1" runat="server" Text="Incluir" PostBackUrl="~/Visao/Adm/CRUDCategoria/Incluir.aspx" /><br /><br />
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" OnRowCommand="GridView1_RowCommand" DataKeyNames="Id">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Departamento_id" HeaderText="Departamento_id" ReadOnly="True" SortExpression="Departamento_id" Visible="False"></asp:BoundField>
                    ...
                    <asp:ObjectDataSource runat="server" ID="ObjectDataSource1" SelectMethod="SelectAll" TypeName="ECommerce.DAL.DALCategoria"></asp:ObjectDataSource>
                    <br />
                </div>
            </div>
        </div>
