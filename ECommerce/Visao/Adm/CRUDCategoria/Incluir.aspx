<%@ Page Title="" Language="C#" MasterPageFile="~/Visao/Adm/AdmMasterPage.Master" AutoEventWireup="true" CodeBehind="Incluir.aspx.cs" Inherits="ECommerce.Visao.Adm.CRUDCategoria.Incluir" Theme="css" %>
                ...
                <div class="col-sm-12">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="ObjectDataSource1" DataTextField="Descricao" DataValueField="Id" OnDataBound="DropDownList1_DataBound"></asp:DropDownList>
