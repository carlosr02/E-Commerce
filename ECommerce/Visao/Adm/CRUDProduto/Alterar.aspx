<%@ Page Title="" Language="C#" MasterPageFile="~/Visao/Adm/AdmMasterPage.Master" AutoEventWireup="true" CodeBehind="Alterar.aspx.cs" Inherits="ECommerce.Visao.Adm.CRUDProduto.Alterar" Theme="css" %>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><asp:Label ID="Label5" runat="server" Text="Quantidade em estoque"></asp:Label></td>
                            <td><asp:TextBox ID="TextBox5" runat="server" TextMode="Number"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td><asp:Label ID="Label6" runat="server" Text="Descrição"></asp:Label></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="ObjectDataSource1" DataTextField="Descricao" DataValueField="Id" AutoPostBack="True"></asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="ObjectDataSource2" DataTextField="Descricao" DataValueField="Id"></asp:DropDownList>
